...
# from apps.ws_channel.models import Chat, Notification
# from rest_framework.response import Response
# from apps.ws_channel.serializers import ChatListSerializer, ChatSerializer, NotificationListSerializer
...
#           notifications_tuple = Notification.objects.filter(user=user).order_by('-created_at')
          
#           notifications = NotificationListSerializer(notifications_tuple, many=True)
          
#           return Response(CustomResponse.success("Notifications retrieved successfully", notifications.data))