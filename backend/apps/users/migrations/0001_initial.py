# Generated by Django 5.1.1 on 2024-10-02 06:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.BooleanField(default=True)),
                ('name', models.CharField(choices=[('admin', 'Admin'), ('superadmin', 'SuperAdmin'), ('user', 'User')], max_length=100, unique=True)),
            ],
            options={
                'abstract': False,
            },
