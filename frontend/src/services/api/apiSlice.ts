...
const apiSlice = createApi({
  ...
  tagTypes: ['JobList', 'CertificationList', 'EducationsList', 'selectprojectsList', 'videoIntroductionList', 'appliedJobs', 'bookmarked', 'NotificationList','ShortList','JobPostEdit'],
  endpoints: () => ({}),
});
