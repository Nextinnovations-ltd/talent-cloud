...
export const SelectedProjects = ({
  ...
  return (
    <div className="relative w-full max-w-[500px]   bg-white rounded-[20px]  flex flex-col gap-4  border-[#E5E7EB]">
      ...
      {project_image_url && (
        <img className="h-[230px] w-full object-center object-cover rounded-lg mb-2 block" src={project_image_url} alt={title} />
      )}
       {!project_image_url && (
        <img className="h-[230px] w-full object-center object-cover rounded-lg mb-2 block" src={DEFAULT_EMPTY} alt={title} />
      )}
