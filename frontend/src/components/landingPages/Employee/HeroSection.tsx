            ...
            <nav className="max-w-[1240px] mx-auto flex justify-between items-center relative z-10 md:px-5 md:py-6 py-[15px] px-[27px]">
              ...
              >
                ...
                <motion.li
                  ...
                  className="list-none"
                >
                  <HashLink smooth to="#why-us" className={linkClass("#why-us")}>Why us</HashLink>
                </motion.li>
                ...
                <motion.li
                  ...
                  className="list-none"
                >
                  <HashLink smooth to="#what-you-get" className={linkClass("#what-you-get")}>What You Get</HashLink>
                </motion.li>
                ...
                <motion.li
                  ...
                  className="list-none"
                >
                  <HashLink smooth to="#find-jobs" className={linkClass("#find-jobs")}>Find Jobs</HashLink>
                </motion.li>
                ...
                <motion.li
                  ...
                  className="list-none"
                >
                  <CommonButton title="Contact us" url='/contact-us' path="emp"/>
                </motion.li>
              </motion.ul>
