...
export function LensDemo({title,description}:{title:string,description:string}) {

    return (
        <div className="w-full  relative rounded-3xl overflow-hidden max-w-md mx-auto  p-8 z-50 bg-gradient-to-r from-[#4752f0f0] to-[#2917ed54] ">
            <Rays />
            {/* <Beams /> */}
            <div className="relative z-30">
                <div
                    className="py-4 relative z-30"
                >
                    <h1 className='text-[30px] text-white font-[500] mb-[40px]'>{title}</h1>
                    <Separator />
                    <p className='text-[14px] text-white mt-[14px]'>{description}</p>
                </div>
            </div>
        </div>
    );
...
const Beams = () => {
    return (
      <svg
        ...
        className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-auto max-w-[600px] pointer-events-none z-[-1]"
      ...
      >
        ...
        <defs>
          <filter id="filter0" x="-192" y="-174" width="452" height="452">
            <feGaussianBlur stdDeviation="56" />
          </filter>
          <filter id="filter1" x="70" y="-238" width="524" height="524">
            <feGaussianBlur stdDeviation="80" />
          </filter>
          <filter id="filter2" x="-71" y="-209" width="524" height="524">
            <feGaussianBlur stdDeviation="80" />
          </filter>
        </defs>
      </svg>
