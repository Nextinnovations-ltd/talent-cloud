...
const githubAuthUrl = "https://github.com/login/oauth/authorize?client_id=Ov23lifgUDFRJT5fmIsG&redirect_uri=http://localhost:8000/api/v1/auth/accounts/github&scope=user:email";
