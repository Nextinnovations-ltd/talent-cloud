...
const NotiBadge = () => {
    ...
    return (
        <div className="relative outline-none w-[40px] border-none ring-0">
            ...
            {
                (data?.data?.unread_count ?? 0) > 0 &&   <div className="absolute flex items-center justify-center  bg-red-500 text-sm text-white rounded-full h-5 w-5 right-0 top-[-10px]">
