...
import { useGetNIExpiredJobsByAdminQuery } from "@/services/slices/adminSlice";
...
import JobCardSkeleton from "../AllJobs/JobCardSkeletion";

const ExpiredJobs = () => {
  const [page, setPage] = useState(1);
  const [sortBy, setSortBy] = useState("-created_at");
  const { data, isLoading, isFetching, error } = useGetNIExpiredJobsByAdminQuery(
